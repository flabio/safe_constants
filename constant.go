...
const (
	...
	RECOVER_PANIC                                 = "Se recuperó de un panic:"
	DB_DIFF_ID                             string = "id <>?"
	DB_EQUAL_ID                            string = "id=?"
	DB_EQUAL_NAME                          string = "name =?"
	DB_ORDER_DESC                          string = "id desc"
	DB_EQUAL_EMAIL_ID                      string = "email=?"
	DB_EQUAL_USER_ID                       string = "user_id =?"
	DB_EQUAL_CITY_ID                       string = "city_id =?"
	DB_LIKE_NAME                           string = "name LIKE?"
	...
	ACTIVE_FIELD_IS_REQUIRED                      = "The active field is required"
	CITY_ID_FIELD_IS_REQUIRED                     = "The city id field is required"
	...
	CITY_ID_IS_REQUIRED                           = "The city id is required."
